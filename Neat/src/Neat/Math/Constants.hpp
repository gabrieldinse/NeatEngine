...
namespace Neat
{
   ...
   template <typename T>
   inline constexpr T oneSixth = static_cast<T>(0.16666666666666666666666666666667);
   ...
   template <typename T>
   inline constexpr T oneThird = static_cast<T>(0.33333333333333333333333333333333);
   ...
   template <typename T>
   inline constexpr T oneOverTwoPi = static_cast<T>(0.15915494309189533576888376337251);

   template <typename T>
   inline constexpr T oneOverThreePi = static_cast<T>(0.10610329539459689051258917558168);

   template <typename T>
   inline constexpr T twoOverPi = static_cast<T>(0.63661977236758134307553505349006);

   template <typename T>
   inline constexpr T twoOverThreePi = static_cast<T>(0.21220659078919378102517835116335);

   template <typename T>
   inline constexpr T threeOverPi = static_cast<T>(0.95492965855137201461330258023509);
   ...
   template <typename T>
   inline constexpr T sinOneHalf = static_cast<T>(0.47942553860420300027328793521557);
   ...
   template <typename T>
   inline constexpr T cosOneHalf = static_cast<T>(0.87758256189037271611628158260383);
   ...
   template <typename T>
   inline constexpr T oneOverSqrtTwo = static_cast<T>(0.70710678118654752440084436210485);

   template <typename T>
   inline constexpr T sqrtThree = static_cast<T>(1.7320508075688772935274463415059);

   template <typename T>
   inline constexpr T oneOverSqrtThree = static_cast<T>(0.57735026918962576450914878050196);
