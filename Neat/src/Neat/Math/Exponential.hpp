...
template <typename T> inline T ln(T value);

template <typename T> inline T exp2(T value);

// Vector
template <UInt32 N, typename T> inline Vector<N, T> log2(const Vector<N, T> &v);

template <UInt32 N, typename T>
inline Vector<N, T> log10(const Vector<N, T> &v);

template <UInt32 N, typename T> inline Vector<N, T> sqrt(const Vector<N, T> &v);
...
template <UInt32 N, typename T> inline Vector<N, T> exp2(const Vector<N, T> &v);
