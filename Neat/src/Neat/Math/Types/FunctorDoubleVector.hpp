...
{
   template <
      template <UInt32 N, typename T> class Vector,
      UInt32 N, typename R, typename T
   ...
   {
      static Vector<2, R> call(R (*function)(T x, T y),
         const Vector<2, T>& va, const Vector<2, T>& vb)
      {
   ...
   {
      static Vector<3, R> call(R (*function)(T x, T y),
         const Vector<3, T>& va, const Vector<3, T>& vb)
      {
         return Vector<3, R>(
            function(va.x, vb.x), function(va.y, vb.y), function(va.z, vb.z));
      }
   };
   ...
   {
      static Vector<4, R> call(R (*function)(T x, T y),
         const Vector<4, T>& va, const Vector<4, T>& vb)
      {
         return Vector<4, R>(
            function(va.x, vb.x), function(va.y, vb.y), function(va.z, vb.z),
            function(va.w, vb.w));
