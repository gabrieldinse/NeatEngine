...
struct TimerNotStartedError : public TimerError {
  TimerNotStartedError(const std::string &msg = "Timer has not been started.")
      : TimerError(msg) {}
};
// -------------------------------------------------------------------------
...
struct QuaternionLerpStepError : public MathError {
  QuaternionLerpStepError(const std::string &msg =
                              "Lerp step parameter t must be in "
                              "range [0, 1]")
      : MathError(msg) {}
};
// -------------------------------------------------------------------------
...
struct CameraTypeHasNotBeenSettedError : public CameraError {
  CameraTypeHasNotBeenSettedError(
      const std::string &msg =
          "Camera type was not setted yet. "
...
struct WrongCameraTypeError : public CameraError {
  WrongCameraTypeError(const std::string &msg =
                           "The camera type you are using does not"
                           "support this method.")
      : CameraError(msg) {}
};
// -------------------------------------------------------------------------
...
struct InvalidEntityError : public EntityError {
  InvalidEntityError(const std::string &msg = "Acessed Entity is invalid.")
      : EntityError(msg) {}
};
...
struct BadComponentAllocationError : public ComponentError {
  BadComponentAllocationError(const std::string &msg =
                                  "You should not delete components directly. "
