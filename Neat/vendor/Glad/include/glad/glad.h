/*
    ...
    OpenGL loader generated by glad 0.1.33 on Mon Mar 30 13:14:41 2020.
...
typedef void (APIENTRYP PFNGLATTACHSHADERPROC)(GLuint program, GLuint proportionalShader);
GLAPI PFNGLATTACHSHADERPROC glad_glAttachShader;
#define glAttachShader glad_glAttachShader
typedef void (APIENTRYP PFNGLBINDATTRIBLOCATIONPROC)(GLuint program, GLuint index, const GLchar *name);
GLAPI PFNGLBINDATTRIBLOCATIONPROC glad_glBindAttribLocation;
#define glBindAttribLocation glad_glBindAttribLocation
typedef void (APIENTRYP PFNGLCOMPILESHADERPROC)(GLuint proportionalShader);
...
typedef void (APIENTRYP PFNGLDELETESHADERPROC)(GLuint proportionalShader);
GLAPI PFNGLDELETESHADERPROC glad_glDeleteShader;
#define glDeleteShader glad_glDeleteShader
typedef void (APIENTRYP PFNGLDETACHSHADERPROC)(GLuint program, GLuint proportionalShader);
...
typedef void (APIENTRYP PFNGLGETSHADERIVPROC)(GLuint proportionalShader, GLenum pname, GLint *params);
GLAPI PFNGLGETSHADERIVPROC glad_glGetShaderiv;
#define glGetShaderiv glad_glGetShaderiv
typedef void (APIENTRYP PFNGLGETSHADERINFOLOGPROC)(GLuint proportionalShader, GLsizei bufSize, GLsizei *length, GLchar *infoLog);
GLAPI PFNGLGETSHADERINFOLOGPROC glad_glGetShaderInfoLog;
#define glGetShaderInfoLog glad_glGetShaderInfoLog
typedef void (APIENTRYP PFNGLGETSHADERSOURCEPROC)(GLuint proportionalShader, GLsizei bufSize, GLsizei *length, GLchar *source);
...
typedef GLboolean (APIENTRYP PFNGLISSHADERPROC)(GLuint proportionalShader);
GLAPI PFNGLISSHADERPROC glad_glIsShader;
#define glIsShader glad_glIsShader
typedef void (APIENTRYP PFNGLLINKPROGRAMPROC)(GLuint program);
GLAPI PFNGLLINKPROGRAMPROC glad_glLinkProgram;
#define glLinkProgram glad_glLinkProgram
typedef void (APIENTRYP PFNGLSHADERSOURCEPROC)(GLuint proportionalShader, GLsizei count, const GLchar *const*string, const GLint *length);
...
typedef void (APIENTRYP PFNGLSPECIALIZESHADERPROC)(GLuint proportionalShader, const GLchar *pEntryPoint, GLuint numSpecializationConstants, const GLuint *pConstantIndex, const GLuint *pConstantValue);
