...
ExampleLayer::ExampleLayer(
  ...
  Neat::FrameBufferSpecification specification{1280, 720};
  m_frameBuffer = Neat::FrameBuffer::create(specification);
}
...
void ExampleLayer::onImGuiRender() {
  ...
  Neat::UInt32 textureID = m_frameBuffer->getColorAttachmentID();
